...
for fileIN in glob.glob("%s/*.txt" %DIR_INPUT):
    t_corrected, t, Delta1, Delta2, Delta, mean, nu0, nubest = u.Compute_correction_Expo1D_ExpoNu(fileIN, N_ref, N_Data,
...
pv1, pv2 = u.Delta_hist(Delta1, Delta2, scale_REF, scale_star, sigma, 
                      df1=1, df2=1, bins1=10, bins2=10, 
                      plot=True, verbose=True)
pv3, pv4 = u.t_hist(t, t_corrected, Delta, Delta1, Delta2, nubest, 
                  ...
                  plot=True, verbose=True)
u.nu_hist(nubest, mean, scale_REF, scale_star, sigma)
u.correlation_plots(t, Delta, Delta1, Delta2, nubest, nu0, scale_REF, scale_star, sigma)
