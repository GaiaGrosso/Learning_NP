...
toy = sys.argv[2]
#EFT path
INPUT_PATH_DATA = sys.argv[3] #EX: '/eos/project/d/dshep/BSM_Detection/DiLepton_EFT06'
...
N_Bkg = 20000
N_ref = 100000
N_Data = int(N_Bkg*cross_EFT*1./cross_SM)
...
nfile_DATA=22 #number of files in EFT repository
...
# define output path
ID = '/EFT_5D_patience'+str(patience)+'_ref'+str(N_ref)+'_bkg'+str(N_Bkg)+'_sig'+str(N_Sig)+'_epochs'+str(total_epochs)+'_latent'+str(latentsize)+'_wclip'+str(weight_clipping)
...
HLF_REF = BuildSample_DY(N_Events=N_ref, INPUT_PATH=INPUT_PATH_BKG, seed=seed, nfiles=nfile_REF)
print(HLF_REF.shape)

#DATA                                                                                                                                                                                                                                                                                                                                           
INPUT_PATH_DATA = INPUT_PATH_DATA + "/"
print('EFT repository: '+INPUT_PATH_DATA)

HLF_DATA = BuildSample_DY(N_Events=N_Data_p, INPUT_PATH=INPUT_PATH_DATA, seed=seed, nfiles=nfile_DATA)
